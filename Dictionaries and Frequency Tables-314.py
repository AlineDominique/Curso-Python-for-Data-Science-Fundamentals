...
for iteration_variable in content_ratings:
    ...
    if iteration_variable == '17+':
        percentage_17_plus = content_ratings[iteration_variable]
...
max_rating_count_tot = max(rating_count_tot) 
min_rating_count_tot = min(rating_count_tot)
